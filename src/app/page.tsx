    ...
    <div>
      <BackgroundLines className="flex items-center justify-center w-full flex-col px-4">
        ...
        <p className="max-w-xl mx-auto text-sm md:text-lg text-neutral-700 dark:text-neutral-400 text-center">
          The smart, easy way to interact with any PDF document, just ask and
          get answers instantly.
        </p>
        <div className="mt-10 flex items-center justify-center">
          <Link
            href="/chat"
            className="rounded-md bg-slate-600 px-3 py-2 text-sm font-medium text-white shadow-xs hover:bg-slate-500 focus-visible:outline-2 focus-visible:outline-offset-2 focus-visible:outline-blue-600 flex z-10"
          >
